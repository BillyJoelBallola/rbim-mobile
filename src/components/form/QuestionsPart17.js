...
const QuestionsPart17 = ({ showSideBar, navigation }) => {
  ...
  return (
    <ScrollView>
      ...
      <HeightSpacer size={20}/>
      <CustomButton text={"NEXT"} onPress={() => navigation.navigate('SurveyForm', { tab: 21 })}/>
      <HeightSpacer size={10}/>
      <CustomButton text={"PREVIOUS"} bgColor={"#808080"} onPress={() => navigation.navigate('SurveyForm', { tab: 19 })} />
    </ScrollView>
  )
}
