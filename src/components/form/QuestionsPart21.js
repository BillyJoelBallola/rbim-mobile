...
const QuestionsPart21 = ({ showSideBar, navigation }) => {
  ...
  return (
    <ScrollView>
                ...
                <View style={styles.column}>
                  ...
                  <View style={{ width: '40%' }}>
                    <CustomDropdown 
                      ...
                      selected={member.questionsAndAnswer[35] || ''}
                      onSelect={value => 
                        handleInputChange(35, 
                          value, 
                          member.questionsAndAnswer, 
                          member.setQuestionAndAnswer
                        )
      ...
      <HeightSpacer size={20}/>
      <CustomButton text={"NEXT"} onPress={() => navigation.navigate('SurveyForm', { tab: 25 })}/>
      <HeightSpacer size={10}/>
      <CustomButton text={"PREVIOUS"} bgColor={"#808080"} onPress={() => navigation.navigate('SurveyForm', { tab: 23 })} />
    </ScrollView>
  )
}
