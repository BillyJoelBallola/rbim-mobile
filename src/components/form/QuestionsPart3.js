...
const QuestionsPart3 = ({ showSideBar, navigation }) => {
  ...
  return (
    <ScrollView>
          ...
          <View key={idx}>
            {
              ...
              <>
                ...
                <View style={styles.column}>
                  ...
                  <View style={{ width: '40%' }}>
                    <CustomDropdown 
                      data={questionSevenData.responses} 
                      selected={member.questionsAndAnswer[6] || ''} 
                      onSelect={(value) => 
                        handleInputChange(6, 
                          value, 
                          member.questionsAndAnswer, 
      ...
      <HeightSpacer size={20}/>
      <CustomButton text={"NEXT"} onPress={() => navigation.navigate('SurveyForm', { tab: 7 })}/>
      <HeightSpacer size={10}/>
      <CustomButton text={"PREVIOUS"} bgColor={"#808080"} onPress={() => navigation.navigate('SurveyForm', { tab: 5 })} />
    </ScrollView>
  )
}
