...
const QuestionsPart15 = ({ setActiveScreen, showSideBar, navigation }) => {
                ...
                <View style={styles.column}>
                  ...
                  <View style={{ width: '40%' }}>
                    <CustomDropdown
                      ...
                      selected={member.questionsAndAnswer[25] || ''}
                      onSelect={value => 
                  ...
                  <View style={{ width: '40%' }}>
                    <CustomDropdown
                      ...
                      selected={member.questionsAndAnswer[26] || ''}
                      onSelect={value => 
                        handleInputChange(26, 
                          value, 
                          member.questionsAndAnswer, 
                          member.setQuestionAndAnswer
                        )
